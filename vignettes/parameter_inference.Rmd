...
## Apply ABC Neural Networks to infer population genetics parameters
...
true_theta = data.frame(param = colnames(theta_observed),
                        value = unlist(c(theta_observed[which.min(abc_popgen$epistemic_uncertainty[,2]),])))
abc_popgen$plot_posterior(which.min(abc_popgen$epistemic_uncertainty[,2])) +
  geom_vline(data = true_theta, aes(xintercept = value))

true_theta = data.frame(param = colnames(theta_observed),
                        value = unlist(c(theta_observed[which.min(abc_popgen$aleatoric_uncertainty[,2]),])))
abc_popgen$plot_posterior(which.min(abc_popgen$aleatoric_uncertainty[,2])) +
  geom_vline(data = true_theta, aes(xintercept = value))


# Plot the worst estimate (larger C.I.)
true_theta = data.frame(param = colnames(theta_observed),
                        value = unlist(c(theta_observed[which.max(abc_popgen$epistemic_uncertainty[,2]),])))
abc_popgen$plot_posterior(which.max(abc_popgen$epistemic_uncertainty[,2])) +
  geom_vline(data = true_theta, aes(xintercept = value))

true_theta = data.frame(param = colnames(theta_observed),
                        value = unlist(c(theta_observed[which.max(abc_popgen$aleatoric_uncertainty[,2]),])))
abc_popgen$plot_posterior(which.max(abc_popgen$aleatoric_uncertainty[,2])) +
  geom_vline(data = true_theta, aes(xintercept = value))
```
...
# Plot the best estimate (lower C.I)
true_theta = data.frame(param = colnames(theta_observed),
                        value = unlist(c(theta_observed[which.min(as.numeric(abc_popgen$epistemic_uncertainty[,2])),])))
abc_popgen$plot_posterior(which.min(as.numeric(abc_popgen$epistemic_uncertainty[,2]))) +
  geom_vline(data = true_theta, aes(xintercept = value))

true_theta = data.frame(param = colnames(theta_observed),
                        value = unlist(c(theta_observed[which.min(as.numeric(abc_popgen$aleatoric_uncertainty[,2])),])))
abc_popgen$plot_posterior(which.min(as.numeric(abc_popgen$aleatoric_uncertainty[,2]))) +
  geom_vline(data = true_theta, aes(xintercept = value))
