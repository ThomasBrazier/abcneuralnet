...
Save the abccn object and fitted model.
...
For Deep Ensemble, there are no posterior samples as in Monte Carlo dropout or Concrete Dropout. Hence no need for the `plot_posterior` method.
