...
<!-- ```{r, echo = T} -->
<!-- abc_popgen$plot_prediction(type = "uncertainty") -->
<!-- abc_popgen$plot_prediction(type = "conformal") -->
<!-- abc_popgen$plot_prediction(type = "posterior quantile") -->
<!-- ``` -->
