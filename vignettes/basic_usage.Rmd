...
abc$plot_predicted(uncertainty_type = "uncertainty")
abc$plot_predicted(uncertainty_type = "uncertainty", plot_type = "errorbar")

abc$plot_predicted(uncertainty_type = "conformal")

abc$plot_predicted(uncertainty_type = "posterior quantile")
```
...
```{r, echo=T}
abc_ensemble$plot_predicted(uncertainty_type = "conformal") +
  geom_point(data = df_train, aes(x = x1, y = y1), color = "blue", alpha = 0.01)

abc_ensemble$plot_predicted(uncertainty_type = "uncertainty") +
  geom_point(data = df_train, aes(x = x1, y = y1), color = "blue", alpha = 0.01)
```
...
```{r}
tabnetabc$plot_predicted(uncertainty_type = "posterior quantile", plot_type = "errorbar")
```
